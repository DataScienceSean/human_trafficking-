...
ggplot(ht_offenses_4_years_clean_df, aes(subgroup = state, area = occ_per_100k, fill = occ_per_100k)) + geom_treemap() + geom_treemap_text(aes(label = state), fontface = "italic", colour = "white", place = "centre", grow = F, reflow = T) + facet_wrap(year~.)
```
